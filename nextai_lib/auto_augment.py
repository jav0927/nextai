...
__all__ = ['device', 'fastai2pil_basis', 'pil2fastai_basis', 'pil2tensor', 'flip_horizontal', 'swap_xy_coords',
           'rotate_bb', 'shear_x_bboxes', 'rotate_bboxes', 'ImageNetPolicy', 'SubPolicy']
